...
export default function ExcerciseDetail({ excercise }: Props) {
  return (
    <div className="mx-auto max-w-[1100px] px-2.5 pb-16">
      ...
      <div className="flex items-center justify-between py-5">
        ...
        <Link
          href={`/excercise/${excercise.id}/edit`}
      ...
      <section className="mt-6 rounded-3xl border border-white/10 bg-gradient-to-br from-[#1e2939] to-[#141d2b] p-6 xl:p-8">
        ...
        <p className="leading-relaxed text-gray-300">{excercise.mainInfo}</p>
      </section>

      {/* ===== ДЕТАЛИ: секции ===== */}
      <div className="mt-8 space-y-6">
        {excercise.sections.length === 0 && (
        ...
        {excercise.sections.map((section, index) => (
          <section
            key={section.id}
